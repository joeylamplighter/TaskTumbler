...
(function () {
  ...
  if (window[TT_TAG]) {
    console.log('Constants already initialized, skipping...');
    return;
  }
  window[TT_TAG] = true;
  ...
  const DEFAULT_SETTINGS = {
    ...
    duelAutoAdvance: true,  // Default to true for fidget-toy rapid choosing
  ...
  console.log("✅ Constants loaded (Defaults Fixed + Category XP Adjust + Safe Globals)");
})();
