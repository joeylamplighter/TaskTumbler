...
// DATA MANAGER
// ===========================================
// ES6 Module - Exports DataManager for modern imports
// Also attaches to window.DataManager for backward compatibility
// ===========================================
...
const setDataVersion = (version) => {
    try {
        ...
        console.warn('Failed to set data version:', err);
    }
};
...
console.log('✅ DataManager loaded (ES6 module)');
