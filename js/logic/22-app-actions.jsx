...
(function () {
  ...
  function createDataActions({ tasks, goals, categories, activities, savedNotes, settings, userStats, allPeople, DM, notify, setTasks, setCategories, setGoals, setSavedNotes, setActivitiesInternal }) {
    ...
    const handleLoadSamples = () => {
      ...
      const sampleTasks = [
        { id: 't1', title: 'Call Alice re: Offer', category: 'Real Estate', subtype: 'Lead Gen', priority: 'High', estimatedTime: 15, people: ['Alice Client', 'Diana Partner', 'Grace Designer'], location: 'Downtown Office', completed: false, createdAt: now, dueDate: tomorrow, startDate: new Date().toISOString().split('T')[0], tags: ['urgent', 'client'], weight: 15 },
        { id: 't2', title: 'Prepare Q4 Taxes', category: 'Finance', subtype: 'Taxes', priority: 'Medium', estimatedTime: 60, people: ['Frank Investor', 'Charlie Lead', 'Diana Partner'], location: '', completed: false, createdAt: now, dueDate: nextWeek, tags: ['finance', 'important'], weight: 12, percentComplete: 30 },
        { id: 't3', title: 'Morning Run', category: 'Health', subtype: 'Cardio', priority: 'Low', estimatedTime: 30, people: ['Alice Client', 'Diana Partner', 'Frank Investor'], location: 'Gym', completed: false, createdAt: now, tags: ['health', 'routine'], weight: 5, recurring: 'Daily' },
        { id: 't4', title: 'Update Listing Photos', category: 'Real Estate', subtype: 'Admin', priority: 'Medium', estimatedTime: 45, people: ['Grace Designer', 'Alice Client', 'Diana Partner'], location: 'Client Home', completed: false, createdAt: now, tags: ['marketing'], weight: 10 },
        { id: 't5', title: 'Review Investment Portfolio', category: 'Finance', subtype: 'Investments', priority: 'Medium', estimatedTime: 45, people: ['Frank Investor', 'Charlie Lead', 'Diana Partner'], location: '', completed: false, createdAt: now, dueDate: tomorrow, tags: ['finance'], weight: 8 },
        { id: 't6', title: 'Complete Online Course Module 3', category: 'Learning', subtype: 'Courses', priority: 'Low', estimatedTime: 90, people: ['Alice Client', 'Charlie Lead', 'Frank Investor'], location: '', completed: false, createdAt: now, tags: ['learning', 'education'], weight: 7, percentComplete: 50 },
        { id: 't7', title: 'Kitchen Renovation Planning', category: 'Home Project', subtype: 'Renovation', priority: 'High', estimatedTime: 120, people: ['Eve Contractor', 'Grace Designer', 'Bob Vendor'], location: '', completed: false, createdAt: now, dueDate: nextWeek, tags: ['home', 'project'], weight: 18, subtasks: ['Get quotes', 'Choose materials', 'Schedule timeline'] },
        { id: 't8', title: 'Team Meeting Prep', category: 'Work', subtype: 'Meetings', priority: 'High', estimatedTime: 30, people: ['Diana Partner', 'Alice Client', 'Frank Investor'], location: 'Downtown Office', completed: false, createdAt: now, dueDate: new Date().toISOString().split('T')[0], tags: ['work', 'meeting'], weight: 12 },
        { id: 't9', title: 'Grocery Shopping', category: 'Personal', subtype: 'Shopping', priority: 'Medium', estimatedTime: 45, people: ['Alice Client', 'Grace Designer', 'Eve Contractor'], location: '', completed: false, createdAt: now, tags: ['errands'], weight: 6, recurring: 'Weekly' },
        { id: 't10', title: 'Write Blog Post on Market Trends', category: 'Work', subtype: 'Deep Work', priority: 'Medium', estimatedTime: 90, people: ['Diana Partner', 'Frank Investor', 'Charlie Lead'], location: 'Coffee Shop', completed: false, createdAt: now, tags: ['writing', 'content'], weight: 10, percentComplete: 20 },
        { id: 't11', title: 'Property Showing with Alice', category: 'Real Estate', subtype: 'Showings', priority: 'High', estimatedTime: 60, people: ['Alice Client', 'Grace Designer', 'Diana Partner'], location: 'Client Home', completed: false, createdAt: now, dueDate: tomorrow, tags: ['showing', 'client'], weight: 16 },
        { id: 't12', title: 'Follow up with Charlie on Investment', category: 'Real Estate', subtype: 'Follow-ups', priority: 'Medium', estimatedTime: 20, people: ['Charlie Lead', 'Frank Investor', 'Diana Partner'], location: '', completed: false, createdAt: now, dueDate: tomorrow, tags: ['follow-up', 'investment'], weight: 11 },
        { id: 't13', title: 'Schedule Plumbing Inspection', category: 'Home Project', subtype: 'Maintenance', priority: 'Medium', estimatedTime: 30, people: ['Bob Vendor', 'Eve Contractor', 'Grace Designer'], location: 'Client Home', completed: false, createdAt: now, dueDate: nextWeek, tags: ['inspection', 'maintenance'], weight: 9 },
        { id: 't14', title: 'Staging Consultation with Grace', category: 'Real Estate', subtype: 'Admin', priority: 'Medium', estimatedTime: 45, people: ['Grace Designer', 'Alice Client', 'Diana Partner'], location: 'Client Home', completed: false, createdAt: now, dueDate: nextWeek, tags: ['staging', 'consultation'], weight: 10 },
        { id: 't15', title: 'Partner Strategy Meeting', category: 'Work', subtype: 'Meetings', priority: 'High', estimatedTime: 90, people: ['Diana Partner', 'Frank Investor', 'Charlie Lead'], location: 'Downtown Office', completed: false, createdAt: now, dueDate: tomorrow, tags: ['strategy', 'meeting'], weight: 14 },
        { id: 't16', title: 'Renovation Budget Review', category: 'Home Project', subtype: 'Renovation', priority: 'Medium', estimatedTime: 60, people: ['Eve Contractor', 'Bob Vendor', 'Grace Designer'], location: '', completed: false, createdAt: now, dueDate: nextWeek, tags: ['budget', 'renovation'], weight: 13 },
        { id: 't17', title: 'Investment Property Tour', category: 'Real Estate', subtype: 'Showings', priority: 'High', estimatedTime: 90, people: ['Charlie Lead', 'Frank Investor', 'Diana Partner'], location: '', completed: false, createdAt: now, dueDate: tomorrow, tags: ['tour', 'investment'], weight: 17 },
        { id: 't18', title: 'Client Feedback Session', category: 'Real Estate', subtype: 'Client Calls', priority: 'Medium', estimatedTime: 30, people: ['Alice Client', 'Diana Partner', 'Grace Designer'], location: 'Coffee Shop', completed: false, createdAt: now, dueDate: nextWeek, tags: ['feedback', 'client'], weight: 8 }
      ];

      // Clear existing tasks first, then set new sample tasks
      ...
      if (setActivitiesInternal || DM?.activities?.setAll) {
        const sampleActivities = [
          ...
          { id: 'a2', title: 'Morning Run', category: 'Health', duration: 1800, type: 'completion', taskId: 't3', people: ['Alice Client', 'Diana Partner', 'Frank Investor'], createdAt: new Date(Date.now() - 1 * 86400000).toISOString() },
          { id: 'a3', title: 'Client Call with Alice', category: 'Real Estate', duration: 900, type: 'completion', taskId: 't1', people: ['Alice Client', 'Diana Partner', 'Grace Designer'], createdAt: new Date(Date.now() - 3 * 86400000).toISOString() },
          { id: 'a4', title: 'Tax Preparation', category: 'Finance', duration: 2700, type: 'focus', taskId: 't2', people: ['Frank Investor', 'Charlie Lead', 'Diana Partner'], createdAt: new Date(Date.now() - 5 * 86400000).toISOString() },
          { id: 'a5', title: 'Gym Workout', category: 'Health', duration: 2400, type: 'completion', createdAt: new Date(Date.now() - 1 * 86400000).toISOString() },
          { id: 'a6', title: 'Online Course Study', category: 'Learning', duration: 5400, type: 'focus', taskId: 't6', people: ['Alice Client', 'Charlie Lead', 'Frank Investor'], createdAt: new Date(Date.now() - 4 * 86400000).toISOString() },
          { id: 'a7', title: 'Team Meeting', category: 'Work', duration: 1800, type: 'completion', taskId: 't8', people: ['Diana Partner', 'Alice Client', 'Frank Investor'], createdAt: new Date(Date.now() - 6 * 86400000).toISOString() },
          { id: 'a8', title: 'Property Showing', category: 'Real Estate', duration: 1800, type: 'completion', taskId: 't11', people: ['Alice Client', 'Grace Designer', 'Diana Partner'], createdAt: new Date(Date.now() - 7 * 86400000).toISOString() },
          { id: 'a9', title: 'Blog Writing', category: 'Work', duration: 3600, type: 'focus', taskId: 't10', people: ['Diana Partner', 'Frank Investor', 'Charlie Lead'], createdAt: new Date(Date.now() - 1 * 86400000).toISOString() },
          { id: 'a10', title: 'Grocery Shopping', category: 'Personal', duration: 1800, type: 'completion', taskId: 't9', people: ['Alice Client', 'Grace Designer', 'Eve Contractor'], createdAt: new Date(Date.now() - 2 * 86400000).toISOString() },
          { id: 'a11', title: 'Investment Review Meeting', category: 'Finance', duration: 1800, type: 'completion', taskId: 't5', people: ['Frank Investor', 'Charlie Lead', 'Diana Partner'], createdAt: new Date(Date.now() - 4 * 86400000).toISOString() },
          { id: 'a12', title: 'Renovation Planning Session', category: 'Home Project', duration: 5400, type: 'completion', taskId: 't7', people: ['Eve Contractor', 'Grace Designer', 'Bob Vendor'], createdAt: new Date(Date.now() - 3 * 86400000).toISOString() },
          { id: 'a13', title: 'Staging Consultation', category: 'Real Estate', duration: 2700, type: 'completion', taskId: 't14', people: ['Grace Designer', 'Alice Client', 'Diana Partner'], createdAt: new Date(Date.now() - 5 * 86400000).toISOString() },
          { id: 'a14', title: 'Partner Strategy Session', category: 'Work', duration: 3600, type: 'completion', taskId: 't15', people: ['Diana Partner', 'Frank Investor', 'Charlie Lead'], createdAt: new Date(Date.now() - 2 * 86400000).toISOString() }
        ];
