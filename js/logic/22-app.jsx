...
const removeSubCategory = (parentCat, subName) => {
  ...
  const allNavItems = [
    ...
    { key: "stats", icon: "📊", label: "Data", displayLabel: "Data", hasDropdown: true, dropdownItems: ["people", "places", "stats:overview", "stats:charts", "stats:history"] },
    { key: "people", icon: "👥", label: "People", displayLabel: "People", groupLabel: "Data" },
    { key: "places", icon: "📍", label: "Places", displayLabel: "Places", groupLabel: "Data" },
