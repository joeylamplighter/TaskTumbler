...
(function() {
  ...
  // ===========================================
  window.SingleSelect = function SingleSelect({
    title = "",
    icon = "",
    options = [],
    value,
  ...
  // ===========================================
  window.DateSelect = function DateSelect({ 
    value, 
    setValue, 
    title = "Due Date", 
    icon = "📅" 
  ...
  // ===========================================
  function GenericMultiSelect({ title, allItems, selectedItems, setSelectedItems, icon, iconSize }) {
  ...
  // ===========================================
  function ViewModeSelect({ value, setValue, activeCount = 0, doneCount = 0, iconSize }) {
    const [isOpen, setIsOpen] = useState(false);
    const [pos, setPos] = useState({ top: 0, left: 0 });
    const btnRef = useRef(null);
    const dropdownRef = useRef(null);
  ...
  // CONFIRM MODAL
  // ===========================================
  function ConfirmModal({ open, onClose, onConfirm, title = 'Confirm', message = 'Are you sure?', confirmText = 'Confirm', cancelText = 'Cancel' }) {
    if (!open) return null;
    return (
  ...
  console.log('✅ 13-01-controls.jsx loaded (Fixed Defaults & Styling)');
})();